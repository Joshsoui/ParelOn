            ...
            >
              <div className="relative overflow-hidden rounded-[28px] p-[1.5px] shadow-[0_0_140px_-30px_var(--color-silver)]">
                <div
                  ...
                  style={{
                    background:
                      "conic-gradient(from 0deg, var(--color-silver), transparent 22%, var(--color-silver-bright), transparent 50%, var(--color-silver-bright), transparent 78%, var(--color-silver))",
                  }}
                />
